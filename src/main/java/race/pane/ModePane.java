...
public class ModePane extends HBox {
    ...
    private static final String EASY_BUTTON_PICTURE = "race/image/1_easyButton.png";
    private static final String NORMAL_BUTTON_PICTURE = "race/image/2_normalButton.png";
    private static final String HARD_BUTTON_PICTURE = "race/image/3_hardButton.png";
