...
public class PFinish extends JPanel {
	...
	private Image buttonEasy = new ImageIcon(getClass().getClassLoader().getResource("race/multimedia/image/restart.png"))
			.getImage();

	private Image buttonNormal = new ImageIcon(getClass().getClassLoader().getResource("race/multimedia/image/close.png"))
			.getImage();
